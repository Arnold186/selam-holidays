...
const testimonials = [
  {
    ...
    name: "Liam Nohkan",
    date: "May 9, 2023",
    comment: "Incredible professionalism! TripRex took all my requirements into account and planned the perfect trip. Highly recommended!",
    rating: 5,
  ...
  },
  {
    ...
    name: "Mateo Daniel",
    date: "May 15, 2023",
    comment: "Absolutely perfect! TripRex made our honeymoon unforgettable from start to finish. We'll definitely be booking through them again!",
    rating: 5,
  ...
  },
  {
    ...
    name: "Lucas Mora",
    date: "May 9, 2023",
    comment: "Incredibly easy-to-use! TripRex helped plan a family trip above and beyond. Thinking about reinventing travel!",
    rating: 5,
